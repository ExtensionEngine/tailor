(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('axios'), require('http-status-codes'), require('axios/lib/core/buildFullPath')) :
  typeof define === 'function' && define.amd ? define(['exports', 'axios', 'http-status-codes', 'axios/lib/core/buildFullPath'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.TailorApi = {}, global.axios, global.httpStatusCodes, global.buildFullPath));
}(this, (function (exports, axios, httpStatusCodes, buildFullPath) { 'use strict';
